...
func RegisterRoutes() {
	...
	http.HandleFunc("/ai-assistant", middleware.OnlyPath("/ai-asistant", middleware.OnlyGet(handlers.Ai_Assistant)))
	http.HandleFunc("/profile", middleware.OnlyPath("/profile", middleware.OnlyGet(handlers.ProfileHandler)))
}
